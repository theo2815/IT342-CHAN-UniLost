...
import { Bell, CheckCircle, XCircle, Clock, Package, Search, AlertTriangle, Check } from 'lucide-react';
import { getRecentNotifications, markAllAsRead, markAsRead, timeAgo } from '../mockData/notifications';
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="nd-item-content">
                                    ...
                                    <span className="nd-item-time">{timeAgo(notif.createdAt)}</span>
                                </div>
